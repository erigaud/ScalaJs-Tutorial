...
/** @constructor */
function $c_Ltutorial_Hello$() {
  $c_O.call(this)
}
$c_Ltutorial_Hello$.prototype = new $h_O();
$c_Ltutorial_Hello$.prototype.constructor = $c_Ltutorial_Hello$;
/** @constructor */
function $h_Ltutorial_Hello$() {
  /*<skip>*/
}
$h_Ltutorial_Hello$.prototype = $c_Ltutorial_Hello$.prototype;
$c_Ltutorial_Hello$.prototype.init___ = (function() {
  return this
});
$c_Ltutorial_Hello$.prototype.main__AT__V = (function(args) {
  var this$1 = $m_Lscalatags_JsDom$all$();
  var jsx$4 = this$1.button__Lscalatags_JsDom$TypedTag();
  $m_Lscalatags_JsDom$all$();
  var jsx$3 = new $c_Lscalatags_JsDom$StringFrag().init___T("Click me");
  ...
  var btn = jsx$4.apply__sc_Seq__Lscalatags_JsDom$TypedTag(new $c_sjs_js_WrappedArray().init___sjs_js_Array(array));
  var this$6 = $m_Lscalatags_JsDom$all$();
  var jsx$9 = this$6.div__Lscalatags_JsDom$TypedTag();
  var jsx$8 = $m_Lscalatags_JsDom$all$().cls__Lscalatags_generic_Attr().$$colon$eq__O__Lscalatags_generic_AttrValue__Lscalatags_generic_AttrPair("foo", $m_Lscalatags_JsDom$all$().stringAttr$1);
  var this$7 = $m_Lscalatags_JsDom$all$();
  var jsx$7 = this$7.div__Lscalatags_JsDom$TypedTag();
  var jsx$6 = $m_Lscalatags_JsDom$all$().cls__Lscalatags_generic_Attr().$$colon$eq__O__Lscalatags_generic_AttrValue__Lscalatags_generic_AttrPair("bar", $m_Lscalatags_JsDom$all$().stringAttr$1);
  var this$8 = $m_Lscalatags_JsDom$all$();
  var jsx$5 = this$8.h2__Lscalatags_JsDom$TypedTag();
  var array$1 = [($m_Lscalatags_JsDom$all$(), new $c_Lscalatags_JsDom$StringFrag().init___T("Hello"))];
  var array$2 = [jsx$6, jsx$5.apply__sc_Seq__Lscalatags_JsDom$TypedTag(new $c_sjs_js_WrappedArray().init___sjs_js_Array(array$1)), btn];
  var array$3 = [jsx$8, jsx$7.apply__sc_Seq__Lscalatags_JsDom$TypedTag(new $c_sjs_js_WrappedArray().init___sjs_js_Array(array$2))];
  var content = jsx$9.apply__sc_Seq__Lscalatags_JsDom$TypedTag(new $c_sjs_js_WrappedArray().init___sjs_js_Array(array$3));
...
var $d_Ltutorial_Hello$ = new $TypeData().initClass({
  Ltutorial_Hello$: 0
}, false, "tutorial.Hello$", {
  Ltutorial_Hello$: 1,
  O: 1
});
$c_Ltutorial_Hello$.prototype.$classData = $d_Ltutorial_Hello$;
var $n_Ltutorial_Hello$ = (void 0);
function $m_Ltutorial_Hello$() {
  if ((!$n_Ltutorial_Hello$)) {
    $n_Ltutorial_Hello$ = new $c_Ltutorial_Hello$().init___()
  };
  return $n_Ltutorial_Hello$
}
/** @constructor */
function $c_jl_Class() {
  $c_O.call(this);
...
$m_Ltutorial_Hello$().main__AT__V($makeNativeArrayWrapper($d_T.getArrayOf(), []));
}).call(this);
//# sourceMappingURL=scalajsapp-fastopt.js.map
