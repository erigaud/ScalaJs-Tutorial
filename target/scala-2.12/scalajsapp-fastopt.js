...
$c_Ltutorial_Hello$.prototype.main__AT__V = (function(args) {
  ...
  var textNode = $m_Lorg_scalajs_dom_package$().document__Lorg_scalajs_dom_raw_HTMLDocument().createTextNode("Hello, world");
  parNode.appendChild(textNode);
  $m_Lorg_scalajs_dom_package$().document__Lorg_scalajs_dom_raw_HTMLDocument().body.appendChild(parNode)
});
